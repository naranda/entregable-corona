(() => {
	...
	const e = 720,
		...
		d = "http://localhost:8080/corona-bciplus/api/log/",
			...
			if (c = f(s) ? (e => {
				...
				try {
					console.log("Enviando el cart start"), await (async(e, {
						...
						return await fetch("http://localhost:8080/corona-bciplus/api/sales/", {
							method: "POST",
							headers: {
								"Content-Type": "application/json",
								"Ocp-Apim-Subscription-Key": y
					...
					const t = "http://localhost:8080/corona-bciplus/api/sales/";
					console.log("API_URL", t);
					const r = "http://localhost:8080/corona-bciplus/api/log/";
					...
					console.log("datosCompra", l), console.log("Error: Catch sendCart before fetch"), await fetch("http://localhost:8080/corona-bciplus/api/log/", {
						method: "POST",
						headers: {
							"Content-Type": "application/json",
